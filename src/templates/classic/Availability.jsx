              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <Button
                    type="submit"
                    variant="contained"
                    sx={{ bgcolor: 'primary.main', color: '#111', fontWeight: 800, '&:hover': { bgcolor: 'primary.main' } }}
                  >
                    Search
                  </Button>
                </Grid>
            ...
            <Grid container spacing={2}>
              {options.map((opt) => (
                <Grid item xs={12} md={6} key={opt.rateKey}>
                  <Paper
                    variant="outlined"
                    sx={{ p: 2, borderColor: 'rgba(255,255,255,.12)', background: 'linear-gradient(180deg, rgba(255,255,255,.04), rgba(255,255,255,.02))' }}
                  >
